...
const HomePage = {
  ...
  renderAwards() {
    ...
    return `
      <section id="awards-section" class="section-padding" style="background:#000;color:#fff;border-top:1px solid #111;overflow:visible;padding-top:6rem;padding-bottom:6rem;min-height:100vh;display:flex;flex-direction:column;justify-content:center;">
